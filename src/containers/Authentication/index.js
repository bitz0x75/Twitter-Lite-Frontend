    ...
    handleSubmit = e => {
        ...
        if (values[2] !== values[3]) {
            ...
            this.props.location.pathname === '/' ?
                dispatch(loginActions.login(data, history)) : dispatch(signupActions.signup(data, history))
        }
    }

    render(){
        const { props } = this;
        const error = props.loginReducer.error ? props.loginReducer.error.response.data : ''
        return (
