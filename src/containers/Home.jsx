...
class Index extends Component {
    ...
    handleChange(event){
        const newValue = 280-event.target.value.length
        this.setState({value: newValue, text_value: event.target.value})
...
const mapDispatchToProps = dispatch => {
    return {
        tweet: data => dispatch(tweetActions.tweet(data)),
    }
}
